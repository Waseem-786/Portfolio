  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        ...
        <meta
          name="description"
          content="Portfolio of Waseem Shahzad, a Software Engineer specializing in web and app development, an expert in Oracle Flexcube, and an Application Consultant."
        />
      </Head>
      ...
      <section
        ...
        ${
          darkMode
            ...
            : "bg-gradient-to-b from-blue-300 to-blue-100 text-gray-900"
        }`}
      >
        <motion.div
        ...
        >
          ...
          >
            Passionate Software Engineer with expertise in web & app development,
            Oracle Flexcube, and technical consulting.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {/* About Me Section */}
      <section
        className={`p-12 text-center rounded-lg shadow-lg transition-all duration-500 ${
      ...
      >
        ...
        <motion.p
          ...
          className="text-lg mt-6 max-w-3xl mx-auto leading-relaxed"
        >
          I am a Software Engineer specializing in web and app development,
          enterprise solutions, and technical consulting. With expertise in
          Oracle Flexcube, PL/SQL, Django, and modern web technologies, I thrive
          on solving complex problems and building efficient, user-centric
          applications.
        </motion.p>
      </section>
          ...
          {[
            {
              ...
              icon: <FaMobileAlt className="text-blue-500 text-6xl mx-auto" />,
              description:
                "Building high-performance, scalable applications with modern frameworks.",
            },
            {
              title: "Oracle Flexcube Consulting",
              icon: <FaCogs className="text-blue-500 text-6xl mx-auto" />,
              description:
                "Expert in Flexcube core banking solutions, customization, and support.",
            },
            {
              title: "Database Optimization",
              icon: <FaDatabase className="text-blue-500 text-6xl mx-auto" />,
              description:
                "Optimizing databases for high availability, security, and performance.",
            },
          ].map((expertise, index) => (
            <motion.div
              key={index}
      ...
      >
        ...
        <Link href="/contact">
          <motion.button
            ...
            className="mt-6 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white font-bold text-lg rounded-lg shadow-lg transition-all duration-300"
          >
            Contact Me
          </motion.button>
        </Link>
