    ...
    <div className={darkMode ? "dark bg-gray-900 text-white" : "bg-gray-100 text-gray-900"}>
      ...
      <main className="container mx-auto p-8">
        ...
        <motion.section
          ...
          className="mt-10 p-8 rounded-lg shadow-lg bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-900"
        >
          <h2 className="text-3xl font-bold text-blue-500 text-center mb-6">Skills & Expertise</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Frontend Development", icon: <FaCode />, skills: ["JavaScript", "Flutter", "Talwind CSS", "BootStrap", "Wordpress"] },
              ...
              { title: "DevOps & Tools", icon: <FaTools />, skills: ["Docker", "Firebase", "Version Control (Git)"] },
              { title: "Soft Skills", icon: <FaUsers />, skills: ["Debugging Skills", "Communication", "Leadership", "Management"] },
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className={`p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:shadow-xl cursor-pointer ${
        ...
        <motion.section 
          ...
          className="mt-10 p-8 rounded-lg shadow-lg bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-900"
        >
          <h2 className="text-3xl font-bold text-blue-500 text-center mb-6">Education</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 text-center">{edu.institution}</p>
                {edu.cgpa && <p className="text-center text-gray-500 dark:text-gray-400">{edu.cgpa}</p>}
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section 
          ...
          className="mt-10 p-8 rounded-lg shadow-lg bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-900"
        >
          <h2 className="text-3xl font-bold text-blue-500 text-center mb-6">Professional Experience</h2>
            ...
            {[
              {
                ...
                description:
                  "Supporting various banks by resolving issues in Oracle Flexcube, writing optimized PL/SQL queries, debugging, and testing performance improvements.",
              },
              {
                ...
                description:
                  "Developed a chatbot using machine learning, implemented an advanced attendance system, and optimized internal database processes.",
              },
              {
                ...
                description:
                  "Worked in a professional call center environment, assisting clients, handling queries, and improving communication and problem-solving skills.",
              },
              ...
              >
                ...
                <p className="mt-2 text-lg text-gray-700 dark:text-gray-300">{experience.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section
          ...
          className="mt-10 p-8 rounded-lg shadow-lg bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-900"
        >
          <h2 className="text-3xl font-bold text-blue-500 text-center mb-6">Hobbies, Interests & Extracurricular Activities</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: "Watching Movies & Series", emoji: "🎬", description: "Big fan of Sci-Fi, Tech, and Thriller genres. I enjoy thought-provoking movies and binge-worthy series." },
              ...
              >
                <div className="text-center">
                  ...
                  <p className="mt-2 text-lg text-gray-700 dark:text-gray-300">{hobby.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
